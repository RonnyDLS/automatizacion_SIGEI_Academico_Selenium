...
public class Solicitud {
    ...
    public static Usuario datosUsuario(){
        ...
        usuarioRegistro.numeroIdentidad = "";
        usuarioRegistro.tipoDocumento = "Pasaporte";
        usuarioRegistro.credencialesLoginSigei.email = "bussoifoiteimmou-2816@yopmail.com";
        ...
        usuarioRegistro.datosAdmision.areaAcademica = "Tecnología en Manufactura Automatizada";
