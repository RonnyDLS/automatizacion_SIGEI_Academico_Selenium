...
public class Registro {
    ...
    public static Usuario datosUsuario(){
        ...
        // Datos personales
        usuarioRegistro.nombre = "Yiyo";
        usuarioRegistro.apellido = "Sarante Ramirez";
        usuarioRegistro.numeroIdentidad = getPasaporte();
        usuarioRegistro.tipoDocumento = "Pasaporte";
        usuarioRegistro.credencialesLoginSigei.password = "12345#Ro";
        usuarioRegistro.credencialesLoginSigei.email = "macrugreugrauddau-8912@yopmail.com";
    ...
    // Loguear al usuario;
    public static void  login(WebDriver driver, Usuario usuarioRegistro){
